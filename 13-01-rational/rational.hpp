...
public:
   ...
   bool operator==( const rational & rhs ) const {
        float fcounter = static_cast<float>(counter);
        float fdenominator = static_cast<float>(denominator);
        float frcounter = static_cast<float>( rhs.counter);
        float frdenominator = static_cast<float>(rhs.denominator);
        return ((fcounter / fdenominator) == (frcounter / frdenominator)) ;
   }
